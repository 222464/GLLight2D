...
{
	m_halfDims = (m_upperBound - m_lowerBound) * 0.5f;
}
...
{
    Vec3f d((p2 - p1) * 0.5f);
    Vec3f e((m_upperBound - m_lowerBound) * 0.5f);
    Vec3f c(p1 + d - (m_lowerBound + m_upperBound) * 0.5f);
...
{
	if(other.m_lowerBound.x < m_lowerBound.x)
		m_lowerBound.x = other.m_lowerBound.x;
	if(other.m_lowerBound.y < m_lowerBound.y)
		m_lowerBound.y = other.m_lowerBound.y;
	if(other.m_lowerBound.z < m_lowerBound.z)
		m_lowerBound.z = other.m_lowerBound.z;
	if(other.m_upperBound.x > m_upperBound.x)
		m_upperBound.x = other.m_upperBound.x;
	if(other.m_upperBound.y > m_upperBound.y)
		m_upperBound.y = other.m_upperBound.y;
	if(other.m_upperBound.z > m_upperBound.z)
